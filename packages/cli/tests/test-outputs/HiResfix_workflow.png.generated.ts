const [OUT_0_2] = cls["HighRes-Fix Script"]({
  "upscale_type": "latent",
  "hires_ckpt_name": "(use same)",
  "latent_upscaler": "nearest-exact",
  "pixel_upscaler": "4x_fatal_Anime_500000_G.pth",
  "upscale_by": 1.25,
  "use_same_seed": false,
  "seed": 914146367174090,
  "control_after_generate": null,
  "hires_steps": 12,
  "denoise": 0.56,
  "iterations": 1,
  "use_controlnet": false,
  "control_net_name": "t2i\\coadapter-canny-sd15v1.pth",
  "strength": 1,
  "preprocessor": "CannyEdgePreprocessor",
  "preprocessor_imgs": true
});
const [OUT_0_1, OUT_1_1, OUT_2_1, OUT_3_1, OUT_4_1] = cls["Efficient Loader"]({
...
const [] = cls["KSampler (Efficient)"]({
  "seed": 1106939166727686,
  ...
  "positive": OUT_1_1,
  "negative": OUT_2_1,
  "latent_image": OUT_3_1,
  "optional_vae": OUT_4_1,
  "script": OUT_0_2
});